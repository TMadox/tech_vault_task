...
class ConverterFormContent extends StatelessWidget {
  ...
  final bool Function(Currency)? disableFrom;
  final bool Function(Currency)? disableTo;
      ...
      child: Column(
        ...
        children: [
          CurrencyDropdown(
            ...
            disabledItemFn: disableFrom,
          ),
          const SizedBox(height: AppConstants.defaultPadding),
          Center(
            child: IconButton.filled(
              onPressed: canSwap ? onSwapCurrencies : null,
